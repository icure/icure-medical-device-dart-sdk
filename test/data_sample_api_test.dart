...
/// tests for DataSampleApi
void main() {
  // final instance = DataSampleApi();
  ...
  group('tests for DataSampleApi', () {
    ...
    test('test createOrModifyDataSamplesFor', () async {
      // TODO
    });
    ...
    test('test deleteDataSamples', () async {
      // TODO
    });
    ...
    //
    //Future<PaginatedListDataSample> filterDataSample(Filter filter) async
    ...
    test('test getDataSampleAttachmentContent', () async {
      // TODO
    });
    ...
    test('test getDataSampleAttachmentDocument', () async {
      // TODO
    });
    ...
    test('test matchDataSample', () async {
      // TODO
    });
    ...
    //
    //Future<Document> setDataSampleAttachment(String dataSampleId, MultipartFile body, { String documentName, String documentVersion, String documentExternalUuid, String documentLanguage }) async
    test('test setDataSampleAttachment', () async {
      // TODO
    });
