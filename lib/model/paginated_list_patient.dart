...
class PaginatedListPatient {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is PaginatedListPatient &&
  ...
  static List<PaginatedListPatient>? listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<PaginatedListPatient>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<PaginatedListPatient>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PaginatedListPatient.listFromJson(entry.value, growable: growable,);
        if (value != null) {
          map[entry.key] = value;
        }
      }
