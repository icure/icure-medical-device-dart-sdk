...
class Measure {
  ...
  @override
  String toString() => 'Measure[value=$value, min=$min, max=$max, ref=$ref, severity=$severity, severityCode=$severityCode, evolution=$evolution, unit=$unit, unitCodes=$unitCodes, comment=$comment, comparator=$comparator]';
